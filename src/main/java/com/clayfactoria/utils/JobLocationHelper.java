...
public final class JobLocationHelper {
    ...
    /**
     * Checks if this is a valid walk location for a job.
     *
     * @param world    The world which the location refers to.
     * @param location The candidate block to use as a walk location.
     * @return <code>true</code> if <code>location</code> is a valid block to use as a walk
     * location. <code>false</code> otherwise.
     */
    public static boolean isValidWalkLocation(World world, Vector3i location) {
        BlockType blockType = world.getBlockType(location);
